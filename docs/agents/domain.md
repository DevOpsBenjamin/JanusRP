...
- **Branch & PR Workflow** : Tout ajout/modification de `CONTEXT.md` ou d'un ADR dans `docs/adr/` doit être réalisé sur la branche dédiée du ticket, soumis via Pull Request et mergé sur `main` (`gh pr merge`) avant la clôture du ticket.
